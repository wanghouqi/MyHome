	...
	$(document).ready(function() {
		...
		$("#saveBtn").click(function() {
			...
			layer.confirm('确认保存当前修改?', function(index) {
				formSubimt(contextPath + "/generaledger/newDetailData/save");
		...
		<td valign="top" id="dataTD">
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select name="typeId">
						<%
							for (RowVO rvo : tvoReturn.toRowVOs()) {
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="radio" name="planFlag" value="<%=Definition.NO%>" title="实际" checked=""> <input type="radio" name="planFlag" value="<%=Definition.YES%>" title="计划">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<textarea name="desc" placeholder="本次收支说明" class="layui-textarea"></textarea>
				</div>
			</div>
		</td>
		<td width="50px">&nbsp;</td>
